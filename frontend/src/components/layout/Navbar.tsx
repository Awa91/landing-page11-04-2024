...
function useOutsideAlerter(ref: React.RefObject<HTMLDivElement>, setOpenNav: (open: boolean) => void) {
  useEffect(() => {
...
export const Navbar: React.FC<NavbarProps> = React.memo(({ logo }) => {
  ...
  return (<>
    <div className="flex flex-row items-center justify-between h-28">
      ...
      {/* Desktop Nav */}
      {/* <div className="flex justify-around w-2/5 mr-12 lg:visible sm:invisible hidden"> */}

      <div className=" justify-around w-2/5 mr-12 lg:flex xl:flex 2xl:flex  hidden">
